function moon_mappers(csbApp) {
    Application.call(this,
        "Moon Mappers",
        {
            "circle-button": [
                "/csb/csb-apps/moon_mappers/images/examples/crater/crater1.png",
                "/csb/csb-apps/moon_mappers/images/examples/crater/crater2.png",
                "/csb/csb-apps/moon_mappers/images/examples/crater/crater3.png",
                "/csb/csb-apps/moon_mappers/images/examples/crater/crater4.png",
                "/csb/csb-apps/moon_mappers/images/examples/crater/crater5.png",
                "/csb/csb-apps/moon_mappers/images/examples/crater/crater6.png",
                "/csb/csb-apps/moon_mappers/images/examples/crater/crater7.png",
                "/csb/csb-apps/moon_mappers/images/examples/crater/crater8.png",
                "/csb/csb-apps/moon_mappers/images/examples/crater/crater9.png",
                "/csb/csb-apps/moon_mappers/images/examples/crater/crater10.png",
                "/csb/csb-apps/moon_mappers/images/examples/crater/crater11.png"
            ],
            "eraser-button": []
        },
        [
            ...
            {
                "type": "find-marks",
                "text": "Try to mark at least <b>10 craters</b>. We're only interested in craters larger than this: <img src='/csb/csb-content/images/applications/tutorials/red-circle.png' style='width: 16px; height: 16px;' /><br /><b>TIP:</b> If a crater is too small, your circle will be <b style='color: red'>red</b>",
                "delay": 500
            },
            {
                "type": "click",
