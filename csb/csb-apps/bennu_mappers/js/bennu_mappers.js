function bennu_mappers(csbApp) {
    ...
    Application.call(this,
        ...
        {
            "circle-button": [ 
                "/csb/csb-apps/bennu_mappers/images/examples/crater/crater1.png",
                "/csb/csb-apps/bennu_mappers/images/examples/crater/crater2.png",
                "/csb/csb-apps/bennu_mappers/images/examples/crater/crater3.png"
            ],
            "eraser-button": [],
            "rock-button": [
                "/csb/csb-apps/bennu_mappers/images/examples/rock/rock1.png",
                "/csb/csb-apps/bennu_mappers/images/examples/rock/rock2.png",
                "/csb/csb-apps/bennu_mappers/images/examples/rock/rock3.png",
            ],
            "boulder-button": [
                "/csb/csb-apps/bennu_mappers/images/examples/boulder/boulder1.png",
                "/csb/csb-apps/bennu_mappers/images/examples/boulder/boulder2.png",
                "/csb/csb-apps/bennu_mappers/images/examples/boulder/boulder3.png",
            ]
        },
        [
            {
                "type": "set-image",
                "image-location": "/csb/csb-apps/bennu_mappers/images/tutorial/bennu-tutorial-1.png",
                "correct-marks": [
            ...
            },
            {
                "type": "dropdown",
                "title": "Tutorial",
                "text": "<div class='app-description'>Welcome to Bennu Mappers! To start,<br />  we'll quickly explain how to do the following:</div><ol><li><img src='/csb/csb-content/images/buttons/Button-erase.png' /> Erase a mistake</li><li><img src='/csb/csb-content/images/buttons/Button-crater.png' /> Find craters</li><li><img src='/csb/csb-content/images/buttons/Button-boulder.png' /> Measure boulders</li><li><img src='/csb/csb-content/images/buttons/Button-rocks.png' /> Mark rocks(!!)</li>",
