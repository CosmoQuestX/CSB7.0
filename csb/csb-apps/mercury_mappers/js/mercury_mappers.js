function mercury_mappers(csbApp) {
    ...
    Application.call(this,
        ...
        {
            "circle-button": [
                "/csb/csb-apps/mercury_mappers/images/examples/crater/crater2.png",
                "/csb/csb-apps/mercury_mappers/images/examples/crater/crater3.png",
                "/csb/csb-apps/mercury_mappers/images/examples/crater/crater5.png",
                "/csb/csb-apps/mercury_mappers/images/examples/crater/crater4.png",
                "/csb/csb-apps/mercury_mappers/images/examples/crater/crater1.png",
                "/csb/csb-apps/mercury_mappers/images/examples/crater/crater6.png",
                "/csb/csb-apps/mercury_mappers/images/examples/crater/crater7.png",
                "/csb/csb-apps/mercury_mappers/images/examples/crater/crater8.png",
                "/csb/csb-apps/mercury_mappers/images/examples/crater/crater9.png",
                "/csb/csb-apps/mercury_mappers/images/examples/crater/crater10.png",
                "/csb/csb-apps/mercury_mappers/images/examples/crater/crater11.png",
                "/csb/csb-apps/mercury_mappers/images/examples/crater/crater12.png"
            ],
            "eraser-button": []
        },
        [
            {
                "type": "set-image",
                "image-location": "/csb/csb-apps/mercury_mappers/images/tutorial/mercury-tutorial-2.png",
                "correct-marks": [
            ...
            {
                "type": "set-image",
                "image-location": "/csb/csb-apps/mercury_mappers/images/tutorial/mercury-tutorial-3.png",
                "correct-marks": [
            ...
            {
                "type": "set-image",
                "image-location": "/csb/csb-apps/mercury_mappers/images/tutorial/mercury-tutorial-4.png",
                "correct-marks": [
            ...
            {
                "type": "find-marks",
                "text": "Try to mark <b>12 craters</b>. We're only interested in craters larger than this: <img src='/csb/csb-content/images/applications/tutorials/red-circle.png' style='width: 16px; height: 16px;' /><br /><b>TIP:</b> If a crater is too small, your circle will be <b style='color: red'>red</b>",
                "delay": 500
            },
            {
                "type": "click",
